    ...
    return (
        <div>
            ...
            <div className='login flex flex-col gap-10 px-0'>
                <h2 className='text-[36px] font-manrope font-bold md:text-[54px] md:font-semibold'>Login <span className='text-[22px]'>as student</span></h2>
                <form className='flex flex-col gap-5 mb-10' action="">
                    ...
                    <Link className='bg-accent rounded-[10px] text-white h-[54px] text-center text-[18px] font-manrope font-semibold flex items-center justify-center' to="/MyProfile">Login to Edify</Link>
